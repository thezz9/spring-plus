...
@DisplayName("검색 성능 테스트 (with index)")
public class UserSearchPerformanceWithIndexTest {
    ...
    public void testQueryDslSearch() {
        long avg = averageExecutionTime(() -> userRepository.findByNicknameQueryDSL(sampleNickname));
